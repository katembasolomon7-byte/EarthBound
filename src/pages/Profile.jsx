  ...
  return (
    <div className="bg-[#f6f7fb] min-h-screen pb-20">
      ...
      <div className="bg-[#2d2d2d] text-white text-center py-3 font-semibold text-lg relative flex items-center justify-center">
        ...
        <span style={{ position: "absolute", right: 20, filter: "brightness(0) saturate(100%)" }}>
          <NotificationBell />
        </span>
      </div>
      ...
      <Section title="Other">
        ...
        >
          <div className="flex items-center gap-3 text-sm">
            <img src={contactIcon} alt="Contact Us" className="w-5 h-5" style={{ filter: "brightness(0) saturate(100%)" }} />
...
function Item({ label, icon, to }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 text-sm">
        <img src={icon} alt={label} className="w-5 h-5" style={{ filter: "brightness(0) saturate(100%)" }} />
