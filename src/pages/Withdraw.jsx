      ...
      <div style={{
        ...
        <button
          style={{
            ...
            background: "none",
            border: "none",
            borderBottom: tab === "withdraw" ? `3px solid ${START_BLUE}` : "3px solid transparent",
            outline: "none",
            cursor: "pointer"
          }}
            ...
            {["reviewing", "success", "reject"].map(type => (
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  fontSize: 18,
                  background: historyTab === type ? START_BLUE : "#fff",
                  color: historyTab === type ? "#fff" : START_BLUE,
                  outline: "none",
                  border: "none",
                  borderRight: type !== "reject" ? `1px solid ${START_BLUE}` : "none",
                  transition: "background 0.2s"
                }}
